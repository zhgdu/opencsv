...
do about them.
   ...
   * The two constructors for StatefulBeanToCsv have a new parameter: the
   fields to ignore. If you are calling these directly instead of using the
   builders we provide, you will have to add the last argument. If you are
   not ignoring any fields, simply pass in null.
